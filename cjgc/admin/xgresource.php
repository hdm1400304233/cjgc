...
{  
//print_r($_POST);		     
$sql="UPDATE `resource` SET weizhi='$_POST[weizhi]',title='$_POST[title]', content='$_POST[content]',money='$_POST[money]' WHERE `id`='$_POST[id]'";
mysql_query($sql);
echo "<script language='javascript'>alert('保存成功');</script>";
echo "<script language='javascript'>location.href=edresource.php;</script>";										
}   
if(isset($_GET['id']))
{
...
?>
<body>
<center><form action="xgresource.php" method="post" name="myform" onsubmit="return chk();">
...
<center><a href="edresource.php">返回</a></center>
</body>
</html>