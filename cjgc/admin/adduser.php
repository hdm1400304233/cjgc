...
else
{
   ...
   die;
		...
		echo "<script language='javascript'>location.href=('eduser.php');</script>";
			}	
			
		}
		?>
<body alink=#333333 vlink=#333333 link=#333333 topmargin=0 leftmargin=0 onLoad="init()">
<h1 align="center">注册</h1>
<br/><br/>
<form action="zhuce.php" name="creator" method="post" onsubmit="return aaaa()" enctype="multipart/form-data">
<script language="javascript">
var where = new Array(35);
function comefrom(loca,locacity) { this.loca = loca; this.locacity = locacity; }
where[0]= new comefrom("请选省","请选城市");
...
where[3] = new comefrom("天津","|和平|东丽|河东|西青|河西|津南|南开|北辰|武清|红挢|塘沽|汉沽|大港|宁河|静海|宝坻|蓟县");
...
<table align="center">
<tr><td width="80" align="left">账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</td><td><input type="text" name="zhanghao" /><font color="red">必填</font></td></tr>
<tr><td align="left">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</td><td><input type="password" name="mima" /><font color="red">必填</font></td></tr>
<tr><td align="left">确认密码</td><td><input type="password" name="remima" /><font color="red">必填</font></td></tr>
<tr><td align="left">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</td><td><input type="text" name="mingzi" /><font color="red">必填</font></td></tr>
<tr><td align="left">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</td><td><input type="radio" name="xingbie" checked="checked" value="男" />男<input type="radio" name="xingbie" value="女" />女</td></tr>
<tr><td align="left">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</td><td><input type="text" name="email" /><font color="red">必填</font></td></tr>
<tr><td align="left">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址</td><td><select name="province" onChange = "select()"></select><select name="city" onChange = "select()"></select><font color="red">必填</font></td></tr>
<tr><td align="left">密码提示</td><td><input type="text" name="mmts" /><font color="red">必填</font></td></tr>
<tr><td align="left">密码答案</td><td><input type="password" name="mmda" /><font color="red">必填</font></td></tr>
<tr><td>验&nbsp;&nbsp;证&nbsp;码</td><td><input type="text"  name="Code" maxlength="4"/><img src="yzm.php"  id="Code"  onClick="Code.src='yzm.php?'+Math.random()"></td></tr>
<tr><td colspan="2" align="center"><input type="submit" name="submit" value="提交" /></td></tr></table></form>
<br/>
</body>
</html