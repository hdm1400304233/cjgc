...
{
	?>
<tr><td height="20" width="40" align="center"><?php echo $row["id"]?></td><td width="200" align="center"><?php echo $row["yonghuming"]?></td><td width="200" align="center"><?php echo $row["yhz"]?></td><td><a href="zz.php?id=<?php echo $row["id"]?>">编辑组</a></td></tr>
<?php } ?>
</table>
</font>
